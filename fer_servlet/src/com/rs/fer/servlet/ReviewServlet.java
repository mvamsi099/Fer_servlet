...
public class ReviewServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		address.setLine1(request.getParameter("lineOne"));
		address.setLine2(request.getParameter("lineTwo"));
		...
		out.println("<tr>");
		out.println("<td colspan='2' align='center'>Review Update Profile</td>");
		out.println("</tr>");
		out.println("<tr>");
		...
		out.println("<td><input type='text' name='lineOne' value='" + address.getLine1() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");

		out.println("<td>Line2 </td>");
		out.println("<td><input type='text' name='lineTwo' value='" + address.getLine2() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");

		out.println("<td>City </td>");
		out.println("<td><input type='text' name='city' value='" + address.getCity() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");

		out.println("<td>State </td>");
		out.println("<td><input type='text' name='state' value='" + address.getState() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");

		out.println("<td>PinCode </td>");
		out.println("<td><input type='text' name='pinCode' value='" + address.getPincode() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");

		out.println("<td>Country </td>");
		out.println("<td><input type='text' name='country' value='" + address.getCountry() + "'disabled = 'true'>");
		out.println("</td>");
		out.println("</tr>");
